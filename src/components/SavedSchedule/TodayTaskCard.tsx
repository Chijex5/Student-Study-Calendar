    ...
    <div className="relative">
      <div
        className={`relative overflow-hidden rounded-xl p-6 transition-all duration-500 ${
          isMissed
            ? "bg-[#FF6B6B] animate-[shake_0.5s_ease-in-out] shadow-lg"
      ...
      >
        ...
        {!isCompleted && !isMissed && (
          <button
            ...
            className="absolute bottom-4 right-4 w-12 h-12 rounded-full bg-[#E040FB] text-white flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-lg active:scale-95"
          >
            <CheckCircle size={24} />
          </button>
        )}
